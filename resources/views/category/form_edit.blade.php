                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="field-1" value="{{ old('name') }}" placeholder="News" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" class="form-control" id="field-2" value="{{ old('slug') }}" placeholder="news-update" required>
